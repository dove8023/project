...
<section class="u_topic_detail center-block mt20 navbar-form u_editor_modal" id="topicForm" ng-controller="form">
	<h1>
		<strong id="pageTitle">直播添加编辑</strong>
	</h1>
	...
	<div class="mb10">
		<label class="pull-left">直播链接:</label>
		<input type="text" name="title"  placeholder="请输入直播链接" ng-model="data.ext_content.url" class="form-control w500">
	</div>
...
<script src="/static/js/pages/content/topic_live.js"></script>
<?php echo $footer; ?>